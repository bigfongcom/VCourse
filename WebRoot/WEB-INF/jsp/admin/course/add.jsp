...
<jsp:include page="../header.jsp" flush="true">
  <jsp:param name="pageTitle" value="添加课程" />
</jsp:include>
...
<!------start content------->
            ...
            <form class="am-form am-form-horizontal"   action="<%=basePath%>admin/course/doadd" method="post" enctype="multipart/form-data">
                    ...
                    <tbody>
						...
						<tr class="gradeX">
						  ...
						  <td align="left">
						  <img   id="thumb_img" style="width: 200px; height: 150px;display:none;">
