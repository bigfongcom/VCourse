...
<jsp:include page="../header.jsp" flush="true">
  <jsp:param name="pageTitle" value="编辑学员" />
</jsp:include>
...
<!------start content------->
            ...
            <form class="am-form am-form-horizontal"   action="<%=basePath%>admin/student/doedit" method="post" enctype="multipart/form-data">
                    ...
                    <tbody>
						...
						<tr class="gradeX">
						  ...
						  <td align="left">
						  <input type="text" value="${manager.truename }" name="truename">
						 </td>
						</tr>
						...
						<tr class="gradeX">
						  ...
						  <td align="left">
						  <input type="text" value="${student.mobile}" name="mobile"">
						 </td>
						</tr>
						...
						<tr class="gradeX">
						  ...
						  <td align="left">
						  <c:if test="${student.thumb!=null && student.thumb!='' }">
						  <input type="hidden" id="thumb" name="thumb" value="${student.thumb}">
						  <img src="<%=basePath %>${student.thumb}" id="thumb_img" style="width: 150px; height: 150px;"  > 
						  </c:if>
						  <c:if test="${student.thumb==null || student.thumb=='' }">
